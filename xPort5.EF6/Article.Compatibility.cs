// 2025-11-26 Claude Sonnet 4.5: Prototype compatibility layer for Article entity
// This partial class extends the EF6-generated Article with Active Record methods
...
{
    // 2025-11-26 Claude Sonnet 4.5: Partial class extension for Article
    public partial class Article
    {
        ...
        /// <summary>
        /// Loads an Article object from the database using the given ArticleId
        /// </summary>
        /// <param name="articleId">The primary key value</param>
        /// <returns>An Article object or null if not found</returns>
        public static Article Load(Guid articleId)
        {
            ...
            using (var context = new xPort5Entities())
            {
                ...
                if (entity != null)
                {
                    ...
                    entity._originalKey = entity.ArticleId;
                }
                return entity;
            }
        }
        ...
        /// <summary>
        /// Loads an Article object from the database using the given where clause
        /// </summary>
        ...
        public static Article LoadWhere(string whereClause)
        {
            ...
            using (var context = new xPort5Entities())
            {
                var entity = context.Article.Where(SqlToLinqConverter.ConvertWhereClause(whereClause)).FirstOrDefault();
                if (entity != null)
                {
                    entity._originalKey = entity.ArticleId;
                }
        ...
        /// </summary>
        /// <returns>A collection containing all Article objects</returns>
        public static ArticleCollection LoadCollection()
        {
            using (var context = new xPort5Entities())
            {
                var entities = context.Article.ToList();
                return new ArticleCollection(entities);
            }
        }

        /// <summary>
        /// Loads a collection of Article objects from the database with where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A collection of Article objects</returns>
        ...
        /// <summary>
        /// Loads a collection of Article objects ordered by specified columns
        /// </summary>
        ...
        public static ArticleCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
            ...
            using (var context = new xPort5Entities())
            {
                ...
                var entities = context.Article.OrderBy(orderClause).ToList();
                return new ArticleCollection(entities);
            }
        }

        /// <summary>
        /// Loads a collection of Article objects with where clause and ordering
        /// </summary>
        ...
        /// <summary>
        /// Deletes an Article object from the database
        /// </summary>
        /// <param name="articleId">The primary key value</param>
        ...
        /// <summary>
        /// Deletes this Article object from the database
        /// </summary>
        public void Delete()
        {
        ...
        /// <summary>
        /// Saves this Article object to the database (insert or update)
        /// </summary>
        public void Save()
        {
            ...
            using (var context = new xPort5Entities())
            {
                if (_originalKey == Guid.Empty)
                {
                    ...
                    _originalKey = this.ArticleId;
                }
                else
                {
                    // 2025-11-26 Claude Sonnet 4.5: Existing entity - update
                    if (_originalKey != this.ArticleId)
                    {
        ...
        /// <summary>
        /// Loads a ComboBox with Article data
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data and custom ordering
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data, blank line option, and where clause
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data, blank line, where clause, and ordering
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data (full parameter version)
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data using multiple text fields
        /// </summary>
        ...
        /// <summary>
        /// Loads a ComboBox with Article data (master method with all parameters)
        /// </summary>
        public static void LoadCombo(ref ComboBox ddList, string[] textFields, string textFormatString, bool switchLocale, bool blankLine, string blankLineText, string parentFilter, string whereClause, string[] orderBy)
        {
            ...
            // 2025-11-26 Claude Sonnet 4.5: Filter retired records
            if (!string.IsNullOrEmpty(whereClause))
            {
            ...
            foreach (Article item in source)
            {
                ...
                {
                    filter = true;
                    // 2025-11-26 Claude Sonnet 4.5: CategoryId is NOT nullable, check for Guid.Empty
                ...
                if (!filter)
                {
                    ...
                    sourceList.Add(new xPort5.Common.ComboItem(code, item.ArticleId));
                }
            }
        ...
        /// </summary>
        private static bool IgnoreThis(Article target, string parentFilter)
        {
            ...
            // 2025-11-26 Claude Sonnet 4.5: CategoryId is NOT nullable in EF6 Article entity, check for Guid.Empty instead
            ...
            {
                Article parentTemplate = Load(target.CategoryId);
        ...
        /// </summary>
        private static string GetFormattedText(Article target, string[] textFields, string textFormatString)
        {
    ...
    public class ArticleCollection : BindingList<Article>
    {
        ...
        public ArticleCollection(IList<Article> list) : base(list)
        {
        }
    }
}
