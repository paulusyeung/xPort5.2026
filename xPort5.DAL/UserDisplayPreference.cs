...
namespace xPort5.DAL
{
    ...
    public class UserDisplayPreference
    {
        ...
        /// </summary>
        public UserDisplayPreference(Guid preferenceId, Guid userId, Guid preferenceObjectId, Dictionary<id, MetadataAttributes> metadataXml)
        {
        ...
        public static UserDisplayPreference Load(Guid preferenceId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@PreferenceId", preferenceId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spUserDisplayPreference_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    UserDisplayPreference result = new UserDisplayPreference();
        ...
        public static UserDisplayPreference LoadWhere(string whereClause)
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spUserDisplayPreference_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    UserDisplayPreference result = new UserDisplayPreference();
        ...
        public static UserPreferenceCollection LoadCollection()
        {
            ...
            return LoadCollection("spUserDisplayPreference_SelAll", parms);
        }
        ...
        public static UserPreferenceCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    UserDisplayPreference tmp = new UserDisplayPreference();
        ...
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@PreferenceId", preferenceId) };
            SqlHelper.Default.ExecuteNonQuery("spUserDisplayPreference_DelRec", parameterValues);
        }
        ...
        public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            {
                source = UserDisplayPreference.LoadCollection(WhereClause, OrderBy, true);
            }
            else
            {
                source = UserDisplayPreference.LoadCollection(OrderBy, true);
            }
        ...
        private static bool IgnorThis(UserDisplayPreference target, string parentFilter)
        {
            bool result = true;
            ...
            {
                UserDisplayPreference parentTemplate = UserDisplayPreference.Load(target.UserId);
                result = IgnorThis(parentTemplate, parentFilter);
            }
            return result;
        }

        private static string GetFormatedText(UserDisplayPreference target, string[] textField, string textFormatString)
        {
    ...
    /// <summary>
    /// Represents a collection of <see cref="UserDisplayPreference">UserPreference</see> objects.
    /// </summary>
    public class UserPreferenceCollection : BindingList<UserDisplayPreference>
    {
    }
}
