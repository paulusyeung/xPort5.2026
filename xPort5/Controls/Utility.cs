        ...
        public class Category
        {
            public static void LoadTree(ref TreeView target)
            {
                ...
                foreach (var dept in depts)
                {
                    ...
                    LoadClass(ref oNode, dt);
                }
            }

            private static void LoadClass(ref TreeNode oNodes, DataTable dt)
            {
                ...
                foreach (var cls in classes)
                {
                    ...
                    LoadCategory(ref oNode, dt);
                }
            }

            private static void LoadCategory(ref TreeNode oNodes, DataTable dt)
            {
